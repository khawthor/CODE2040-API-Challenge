# author: Kenneth Hawthorne
# email : khawthor@fau.edu
...
# splitting the datestamp into separate variables
...
send = {'token':'haTtyCr77h', 'datestamp':resTime}
